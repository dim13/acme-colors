...
highlight! Pmenu guibg=#aeeeee guifg=#000000 gui=NONE ctermbg=159 ctermfg=232 cterm=NONE
...
highlight! Todo guibg=bg guifg=fg gui=bold ctermbg=bg ctermfg=fg cterm=bold
